...
```{r QTLtools_bamstat, echo=FALSE, fig.height=4, fig.width=18, warning=FALSE, fig.cap= "Quality check on sequence data"}
library(readr)
library(kableExtra)
...
```{r quan, echo=FALSE, fig.height=8, fig.width=16, message=FALSE, warning=FALSE, fig.cap= "Boxplot of the experesion in terms of RPKM for all regios, linear (top) log_10 (down)"}
...
###### Boxplot cis nominal non-FDR dummy 
