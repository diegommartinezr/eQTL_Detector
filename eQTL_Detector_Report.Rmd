...
```{r mbv, echo=FALSE, fig.height=20, fig.width=20, message=FALSE, warning=FALSE, paged.print=FALSE}
library(readr)
library(tidyverse)
library(gghighlight)
...
hist(cis_nominals$`nominal P-value`,
     frame = F,
     xlab = "nominal P-value",
     sub = "",
     main = "Density plot of the nomial P-value of al variants ",
     col = "blue")

hist(subset_cis_nominal$`nominal P-value`,
     frame = F,
     xlab = "nominal P-value",
     sub = "",
     main = "Density plot of the nomial P-value of the top variants ",
     col = "red")


knitr::kable(subset(cis_nominals, cis_nominals$`flag equal to 1 is the variant is the top variant in cis` ==1),
             escape = FALSE,
             format='html',
             cex =0.6)
...
library(readr)
home <- getwd()
Results_pca<- file.path(home,"Results/cis_permutation")

cis_permutation <- read_table2("Results/cis_permutation/permutation.txt", 
    col_names = FALSE)
...
hist(cis_permutation$`empirircal P-value`,
     frame = F,
     xlab = "nominal P-value",
     sub = "",
...
hist(cis_permutation$`beta distribution P-value`,
     frame = F,
     xlab = "nominal P-value",
     sub = "",
...
plot(cis_permutation$`empirircal P-value`,
     cis_permutation$`beta distribution P-value`,
     xlab="Direct method", ylab="Beta approximation", main="")
```
